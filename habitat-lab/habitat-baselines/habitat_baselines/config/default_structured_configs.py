...
# @dataclass
# class TentLossConfig(AuxLossConfig):
#     """TENT adaptation"""
...
@dataclass
class EvaluatorConfigTopDown(HabitatBaselinesBaseConfig):
    """
    `_target_` points to the `Evaluator` class to instantiate to evaluate the
    policy during evaluation mode.
    """
    ...
    _target_: str = (
        "habitat_baselines.rl.ppo.habitat_evaluator_topdown.HabitatEvaluatorTopDown"
    )
...
@dataclass
class HabitatBaselinesConfigTopDown(HabitatBaselinesBaseConfig):
    ...
    evaluator: EvaluatorConfigTopDown = EvaluatorConfigTopDown()
...
@dataclass
class HabitatBaselinesRLConfigTopDown(HabitatBaselinesConfigTopDown):
    rl: RLConfig = RLConfig()
...
cs.store(
    group="habitat_baselines",
    name="habitat_baselines_rl_config_topdown",
    node=HabitatBaselinesRLConfigTopDown(),
)
cs.store(
    group="habitat_baselines",
