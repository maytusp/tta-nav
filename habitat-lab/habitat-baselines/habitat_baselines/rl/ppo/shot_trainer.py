...
@baseline_registry.register_trainer(name="shot")
class ShotTrainer(BaseRLTrainer):
        ...
        with g_timer.avg_time("trainer.update_stats"):
            ...
            if self.count < 100:
                ...
                if self.config.adaptation.adaptation_phase:
                    ...
                    img_save_dir = "../scratch/temp/"
                if not(os.path.exists(img_save_dir)):
                    os.makedirs(img_save_dir)
                for i in range(len(observations)):
                    cv2.imwrite(f'{img_save_dir}/{self.count}.png', cv2.cvtColor(observations[i]["rgb"], cv2.COLOR_RGB2BGR))
