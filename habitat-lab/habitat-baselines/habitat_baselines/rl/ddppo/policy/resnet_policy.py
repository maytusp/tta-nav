...
from habitat_baselines.rl.ppo import Net, NetPolicy, NetPolicyTent
...
# This is modified PointNavResNetPolicy which uses BatchNorm
...
# This is original PointNavResNetPolicy which uses GroupNorm
@baseline_registry.register_policy
class PointNavResNetPolicyGN(NetPolicy):
    def __init__(
        self,
        observation_space: spaces.Dict,
        action_space,
...
@baseline_registry.register_policy
class PointNavResNetPolicyTent(NetPolicyTent):
    def __init__(
        self,
        observation_space: spaces.Dict,
        action_space,
        ...
        **kwargs,
        ...
        # print("USE TENT POLICY (resnet_policy.py)")
...
class PointNavResNetNet(Net):
    ...
    def __init__(
        ...
        if norm == "groupnorm":
            ...
            from habitat_baselines.rl.ddppo.policy import resnetbn as resnet
        super().__init__()
