...
class LoRALSTMStateEncoder(RNNStateEncoder):
    def __init__(
        self,
        input_size: int,
        hidden_size: int,
...
def build_rnn_state_encoder(
    ...
    elif rnn_type == "loralstm":
        return LoRALSTMStateEncoder(input_size, hidden_size, num_layers, subspace_size)
    else:
