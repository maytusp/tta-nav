...
def get_dataset(name, root, image_size, norm=True, flip=False, corruption_type=None, severity=None,return_orig=False, **kwargs):
    ...
    if name == "celeba":
        ...
        dataset = GibsonDataset(root, norm=norm, transform=transform, corruption_type=corruption_type, severity=severity, 
                                return_orig=return_orig, **kwargs)
